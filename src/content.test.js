...
assert(!/showSoftPaywall = paywallGate && !bajioUnlockFlash && !bajioFlashPending && !isBajioUnlockFlashDue\(\) && !/.test(appSrc), "paywall gate does not wait on CDMX, Oaxaca, or Yucatán");
...
const yucatanFlashChunk = appSrc.slice(appSrc.indexOf('data-testid="yucatan-unlock-flash"'), appSrc.indexOf("SOFT PAYWALL"));
