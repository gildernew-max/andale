...
assert(appSrc.includes("MEMORY_CARD_MIN"), "Memory card min-height is the size lock");
assert(appSrc.includes("MEMORY_CARD_TYPE"), "Memory face type is the size lock");
