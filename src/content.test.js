...
assert(UI.es.hubStories === "Stories" && UI.es.hubStoriesSub === "Cuentos", "ES Stories / Cuentos");
assert(UI.en.hubStories === "Stories" && UI.en.hubStoriesSub === "Cuentos", "EN Stories / Cuentos");
assert(UI.es.hubGames === "Games" && UI.es.hubGamesSub === "Match & play", "Games / Match & play");
assert(UI.es.hubDoctor === "Phrase Doctor" && UI.es.hubDoctorSub === "Arregla", "Phrase Doctor / Arregla");
assert(UI.es.hubEighty === "80/20" && UI.es.hubEightySub === "Prioriza", "80/20 / Prioriza");
assert(UI.en.hubEighty === "80/20" && UI.en.hubEightySub === "Prioriza", "EN 80/20 / Prioriza");
assert(UI.es.hubPins === "Pin chase" && UI.es.hubPinsSub === "Unlock Mexico", "Pin chase / Unlock Mexico");
assert(UI.es.hubFlash === "Flashcards" && UI.es.hubFlashSub === "Flip & keep", "Flashcards / Flip & keep");
...
assert(appSrc.includes("eighty-twenty-sub"), "80/20 second line is testable");
...
assert(appSrc.includes("L.hubEightySub"), "80/20 hub tile second line follows uiLang");
