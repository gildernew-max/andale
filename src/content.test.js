...
assert(!/showSoftPaywall = paywallGate && !bajioUnlockFlash && !bajioFlashPending && !isBajioUnlockFlashDue\(\) && !/.test(appSrc), "paywall gate does not wait on CDMX");
...
const cdmxFlashChunk = appSrc.slice(appSrc.indexOf('data-testid="cdmx-unlock-flash"'), appSrc.indexOf("SOFT PAYWALL"));
