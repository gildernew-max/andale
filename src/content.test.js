...
assert(appSrc.includes("waitlistPrompt(uiLang)"), "waitlist prompt follows uiLang in the strip");
assert(appSrc.includes("waitlistPlaceholder(uiLang)"), "waitlist placeholder follows uiLang");
assert(appSrc.includes("waitlistCta(uiLang)"), "waitlist CTA follows uiLang");
assert(appSrc.includes("waitlistPrivacy(uiLang)"), "waitlist privacy follows uiLang");
assert(appSrc.includes("waitlistSuccess(uiLang)") && appSrc.includes("waitlistError(uiLang)"), "waitlist success and error follow uiLang");
...
const waitlistSrc = appSrc.slice(appSrc.indexOf('data-testid="soft-paywall-waitlist"'), appSrc.indexOf("A2HS:"));
assert(paywallLayout.indexOf("soft-paywall-dismiss") < paywallLayout.indexOf("soft-paywall-waitlist"), "waitlist sits under continue free");
assert(paywallLayout.indexOf("soft-paywall-annual") < paywallLayout.indexOf("soft-paywall-waitlist"), "waitlist does not outrank annual");
