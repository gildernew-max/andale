...
assert(appSrc.includes('src={`${import.meta.env.BASE_URL}mascot/axolotl.png`}'), "LogoMark still points at mascot/axolotl.png");
...
assert(existsSync(mascotPng), "Confident mark lives at public/mascot/axolotl.png");
assert(readFileSync(mascotPng).subarray(0, 8).equals(pngMagic), "mascot/axolotl.png is a real PNG, not JPEG-named-.png");
...
assert(indexHtml.includes("mascot/axolotl.png"), "og/twitter image stays the mascot path");
