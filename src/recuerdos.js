 ...
 * Yucatán 77,60 is peninsula land on the Dave-cleared art (was 82,40 — Gulf water north of the hook).
 */
export const RECUERDOS_PINS = [
  ...
  { id: "yucatan", es: "Yucatán", en: "Yucatán", x: 77, y: 60, storyIds: ["story-2"] },
