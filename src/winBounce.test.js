...
assert(appSrc.includes("playLecturaWin"), "later stories go to the done screen without the fly-away beat");
assert(appSrc.includes("if (playStory0) {\n        winBouncePlayed.current = true;\n        setWinBounce(true);"), "story-0 path still stamps the first-win bird flag");
