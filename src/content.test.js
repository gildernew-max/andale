...
assert(appSrc.includes("data-testid=\"crossword-start\""), "Crucigrama lives under Games next to Memory");
assert(appSrc.includes("startCrossword(\"games\")"), "Games hub starts Crucigrama with games return");
assert(appSrc.includes("crosswordTitle(uiLang)"), "Crucigrama title follows uiLang");
assert(appSrc.includes("<CrosswordMark"), "flat geometric crossword mark is wired");
assert(appSrc.includes("<CrosswordPlayfield"), "Crucigrama playfield is wired");
assert(!appSrc.includes("CRUCIGRAMA / CROSSWORD"), "no bilingual Crucigrama lockup");
