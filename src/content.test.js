...
assert(nextHoy?.title === "Noche de faroles", "tomorrow Hoy on 2026-09-05 is Noche de faroles");
assert(nextHoy?.titleEn === "Night of lanterns", "EN tomorrow Hoy on 2026-09-05 is Night of lanterns");
assert(comeBackTomorrowLine({ lang: "es", nextTitle: nextHoy.title }) === "Vuelve mañana por «Noche de faroles».", "George ES teaser lock: Vuelve mañana por «{title}».");
assert(comeBackTomorrowLine({ lang: "en", nextTitle: nextHoy.titleEn }) === "Come back tomorrow for “Night of lanterns”.", "George EN teaser lock: Come back tomorrow for “{title}”.");
