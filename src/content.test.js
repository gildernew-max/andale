...
assert(!/showSoftPaywall = paywallGate && !bajioUnlockFlash && !bajioFlashPending && !isBajioUnlockFlashDue\(\) && !/.test(appSrc), "paywall gate does not wait on CDMX or Oaxaca");
...
const oaxacaFlashChunk = appSrc.slice(appSrc.indexOf('data-testid="oaxaca-unlock-flash"'), appSrc.indexOf("SOFT PAYWALL"));
