...
assert(nextHoy?.title === "En la farmacia", "tomorrow Hoy on 2026-09-05 is En la farmacia");
assert(nextHoy?.titleEn === "At the pharmacy", "EN tomorrow Hoy on 2026-09-05 is At the pharmacy");
assert(comeBackTomorrowLine({ lang: "es", nextTitle: nextHoy.title }) === "Vuelve mañana por «En la farmacia».", "George ES teaser lock: Vuelve mañana por «{title}».");
assert(comeBackTomorrowLine({ lang: "en", nextTitle: nextHoy.titleEn }) === "Come back tomorrow for “At the pharmacy”.", "George EN teaser lock: Come back tomorrow for “{title}”.");
