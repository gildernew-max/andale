...
const TODAY_SCENES = [
  {
    id: "taqueria",
    title: "Taquería sin miedo",
    titleEn: "No-Fear Taquería",
    city: "CDMX",
    color: D.green,
    dark: D.greenDark,
    host: "luna",
    ...
    setup: "La fila avanza, el taquero pregunta rápido y todos parecen saber el código secreto.",
    setupEn: "The line is moving, the taco cook talks fast, and everyone seems to know the secret code.",
...
const UI = {
  es: {
    ...
    storyPrefix: "Cuento", shortcuts: "Luna, Don Rafa y Valeria te acompañan. Atajos: 1–4 · Enter",
  ...
  en: {
    ...
    storyPrefix: "Story", shortcuts: "Luna, Don Rafa, and Valeria are with you. Shortcuts: 1–4 · Enter",
