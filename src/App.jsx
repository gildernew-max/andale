              ...
              return (
                <div key={card.id} className="memory-cell" style={{ minHeight: MEMORY_CARD_MIN, width: "100%", minWidth: 0, display: "flex", height: "100%" }}>
                  <button
                    ...
                    data-card-type={MEMORY_CARD_TYPE}
                    ...
                    style={{
                      ...
                      height: dragging && drag.h ? drag.h : "100%",
                      minWidth: 0,
...
},
{
  ...
  paragraphs: [
    ...
    "La mañana que la entrevisté, servía mole sobre pollo con la mano derecha mientras cobraba con la izquierda. Cien pesos el plato. Cobra menos a los estudiantes y a los viejitos. A los gringos, dice riéndose, cien y un peso de bendición. Nadie regatea con ella. Aquí no se regatea. Es una regla no escrita del mercado.",
    "Le pregunté si pensaba retirarse algún día. Me miró como si hubiera dicho una grosería y abrió las manos sobre el puesto. «¿Retirarme? ¿A hacer qué? Mi nieta está aprendiendo. Cuando me tiemble el pulso, ella tomará la cuchara y yo seré la abuela que vigila desde la silla. Pero todavía no me tiembla nada.»",
    ...
    "Al final me pasó un sobre sencillo. «Eres mexicano», dijo. «Precio de la casa.» Adentro iban ochenta pesos de cuenta. Le di cien. «El peso extra es por la bendición», le dije, y se rio tanto que casi se le cae la cuchara.",
  ],
  glossary: {
...
},
{
  ...
  paragraphs: [
    ...
    "El año pasado murió Don Manuel, el cuarto miembro del grupo. Tenía ochenta y siete años y un cáncer que llevaba escondiendo dos. En su honor, los otros tres jugaron una partida sin pareja, repartiendo igualmente las diez fichas faltantes sobre el lugar vacío. Don Pepe ganó. No celebraron. Don Ernesto sirvió cuatro tequilas, brindaron en silencio, y dejaron el cuarto sin tocar hasta que se evaporó solo.",
  ...
  glossary: {
    ...
    sabemos: ["we know"], dijo: ["said"], Pepe: ["Pepe"], joven: ["young"], setenta: ["seventy"],
...
const TODAY_SCENES = [
  ...
  },
  {
    ...
    setup: "Te duele la garganta desde anoche. En la farmacia no hay médico — solo el mostrador.",
    setupEn: "Your throat's hurt since last night. No doctor at the pharmacy — just the counter.",
    line: "Oye, ¿me recomienda algo para la garganta? Sin receta, si se puede.",
    answers: ["Oye, ¿me recomienda algo para la garganta? Sin receta, si se puede.", "¿Me recomienda algo para la garganta? Sin receta, si se puede."],
    explain: "Farmacia de barrio: corto, claro, «sin receta» antes de que te manden al doctor.",
    question: "En el mostrador, «¿me recomienda algo…? Sin receta…» suena:",
    questionEn: "At the counter, «¿me recomienda algo…? Sin receta…» sounds:",
    choices: ["natural y práctico", "de consulta médica formal", "agresivo"],
    answer: "natural y práctico",
  },
  {
    id: "casa-plomero",
    title: "WhatsApp del plomero",
    titleEn: "Plumber WhatsApp",
    city: "San Miguel",
    color: D.green,
    dark: D.greenDark,
    host: "luna",
    storyId: "story-9",
    units: ["mex", "registro", "pronombres"],
    setup: "Se te tapó el lavabo. El plomero te escribe por WhatsApp — quiere hora y que no limpies nada.",
    setupEn: "The sink's clogged. The plumber texts on WhatsApp — wants a time, and don't touch anything.",
    ...
    question: "En WhatsApp con el plomero, «Oye, ¿puedes venir hoy en la tarde? No toqué nada.» suena:",
    questionEn: "On WhatsApp with the plumber, «Oye, ¿puedes venir hoy en la tarde? No toqué nada.» sounds:",
    choices: ["natural y claro", "de correo formal", "agresivo"],
    answer: "natural y claro",
  },
  {
    id: "gente-vecino",
    title: "WhatsApp del vecino",
    titleEn: "Neighbor WhatsApp",
    city: "San Miguel",
    color: D.green,
    dark: D.greenDark,
    host: "luna",
    storyId: "story-9",
    units: ["mex", "registro", "pronombres"],
    setup: "El vecino te invita a una comida el domingo. Quieres ir, pero ya tienes planes.",
    setupEn: "The neighbor invites you to lunch on Sunday. You want to go, but you've already got plans.",
    line: "Qué padre, gracias. Ese día no puedo — ¿la otra semana?",
    answers: ["Qué padre, gracias. Ese día no puedo — ¿la otra semana?", "Qué padre, gracias. Ese día no puedo. ¿La otra semana?"],
    explain: "Declinar sin cortar: agradeces, dices que no puedes, ofreces otra fecha.",
    explainEn: "Soft decline: thank them, say you can't, offer another day.",
    question: "En WhatsApp con el vecino, «Qué padre, gracias. Ese día no puedo — ¿la otra semana?» suena:",
    questionEn: "On WhatsApp with the neighbor, «Qué padre, gracias. Ese día no puedo — ¿la otra semana?» sounds:",
    choices: ["cordial y claro", "de correo formal", "frío / rechazante"],
    answer: "cordial y claro",
  },
  {
    id: "calle-direccion",
    title: "En la calle",
    ...
    storyId: "story-9",
    units: ["mex", "registro", "pronombres"],
    setup: "Te perdiste cerca del jardín. Preguntas a alguien que va caminando — corto, sin sonar de mapa.",
  ...
  },
  {
    ...
    line: "Buenas. Quiero agendar una cita para abrir una cuenta, por favor.",
    answers: ["Buenas. Quiero agendar una cita para abrir una cuenta, por favor.", "Quiero agendar una cita para abrir una cuenta, por favor."],
    explain: "Trámite por WhatsApp: saludo corto + «agendar una cita» + el motivo. Sin ensayo.",
    explainEn: "Office WhatsApp: short hello + «agendar una cita» + the reason. No speech.",
    question: "En WhatsApp con el banco, «Quiero agendar una cita para abrir una cuenta» suena:",
    questionEn: "On WhatsApp with the bank, «Quiero agendar una cita para abrir una cuenta» sounds:",
    choices: ["claro y práctico", "de correo formal largo", "agresivo"],
...
const PHRASE_DOCTOR = [
  ...
  {
    awkward: "Necesito obtener medicina para mi garganta.",
    natural: "¿Me da algo para la garganta, por favor?",
    formal: "¿Podría darme algo para la garganta, por favor?",
    text: "¿Me das algo para la garganta?",
    diagnosis: "«Obtener medicina» sounds like paperwork. At the counter, «me da / me das algo para…».",
    skill: "Vida diaria",
  },
  {
    awkward: "Necesito obtener un plomero para mi lavabo.",
...
export default function App() {
  ...
  const [sobremesaOpen, setSobremesaOpen] = useState(false);
  const [sobremesaTipsOpen, setSobremesaTipsOpen] = useState(false);
  const [sobremesaDeepenOpen, setSobremesaDeepenOpen] = useState(false);
  const closeSobremesa = () => {
    setSobremesaOpen(false);
    setSobremesaTipsOpen(false);
    setSobremesaDeepenOpen(false);
  };
  ...
  useEffect(() => {
    if (!shouldPlayWinBounce(session) && !shouldPlayStory0Beat(session) && !shouldPlayHoyBeat(session) && !shouldPlayDoctoraBeat(session) && !shouldPlayLecturaWin(session)) return undefined;
    const img = new Image();
  ...
  useEffect(() => {
    ...
    if (!shouldPlayWinBounce(session) && !shouldPlayStory0Beat(session) && !shouldPlayHoyBeat(session) && !shouldPlayDoctoraBeat(session)) return;
    winBouncePlayed.current = true;
    setWinBounce(true);
  }, [screen, session]);
  useEffect(() => {
  ...
  useEffect(() => {
    if (isYucatanUnlockFlashLive() || isYucatanUnlockFlashDue()) {
      setYucatanUnlockFlash(true);
    }
  }, []);
  useEffect(() => {
    if (screen !== "done") return;
    if (!shouldShowYucatanUnlockFlash({
      yucatanUnlockSeen: !!prog.yucatanUnlockSeen,
      streak4HoyEso: isStreak4HoyEsoWin(session),
  ...
  }, [screen, session, prog.yucatanUnlockSeen, prog.streak, prog.lastDay]);
  useEffect(() => {
    if (!yucatanUnlockFlash) return undefined;
    // Persist Open only once the glow is on screen — CONTINUE must not flip the
    // map pin and then race past the overlay (same class as Oaxaca persist-on-CONTINUE).
    save((prev) => (prev.yucatanUnlockSeen ? prev : { ...prev, yucatanUnlockSeen: true }));
    const hide = setTimeout(() => {
      markYucatanUnlockFlashDue(false);
      setYucatanUnlockFlash(false);
      const dest = yucatanFlashNextRef.current || "home";
      yucatanFlashNextRef.current = null;
      setYucatanFlashPending(false);
      setScreen(dest);
      if (dest === "home") setTab("camino");
  ...
  const continueFromWin = () => {
    ...
    // Stale Oaxaca due from streak-3 must not steal streak-4 Yucatán once Oaxaca was seen.
    const willOaxacaFlash = !willFlash && !willCdmxFlash && (
    ...
    if (willYucatanFlash && next === "home") {
      markYucatanUnlockFlashDue(true);
      setYucatanFlashPending(false);
      yucatanFlashNextRef.current = next;
      setYucatanUnlockFlash(true);
    } else if (willYucatanFlash) {
      markYucatanUnlockFlashDue(true);
      setYucatanFlashPending(true);
      yucatanFlashNextRef.current = next;
    }
  ...
  const dismissSessionClose = () => {
    ...
    if (bajioFlashPending || isBajioUnlockFlashDue()) {
      ...
      markOaxacaUnlockFlashDue(true);
      setOaxacaUnlockFlash(true);
    } else if (yucatanFlashPending || isYucatanUnlockFlashDue()) {
      setYucatanFlashPending(false);
    ...
    <div data-testid="app-shell" style={{ minHeight: "100vh", background: D.bg, color: D.ink, fontFamily: "'Nunito','Avenir Next',system-ui,sans-serif", paddingBottom: inLesson ? 0 : "calc(70px + env(safe-area-inset-bottom, 0px))" }}>
      <style>{`
        ...
        * { -webkit-tap-highlight-color: transparent; }
        ...
        .memory-card { width:100%; min-width:0; max-width:100%; min-height:${MEMORY_CARD_MIN}px; height:100%; flex:1 1 auto; white-space:normal; overflow-wrap:anywhere; font-size:${MEMORY_CARD_TYPE}px; font-weight:900; line-height:1.1; letter-spacing:-0.03em; text-align:center; padding:16px 8px; }
        .word-chip.memory-card { display:flex; width:100%; min-width:0; max-width:100%; min-height:${MEMORY_CARD_MIN}px; height:100%; flex:1 1 auto; white-space:normal; overflow-wrap:anywhere; word-break:break-word; font-size:${MEMORY_CARD_TYPE}px; font-weight:900; line-height:1.1; letter-spacing:-0.03em; text-align:center; padding:16px 8px; }
      ...
      {/* Yucatán unlock flash: once on streak-4 Hoy ¡Eso! / That's it. Then close or idle. */}
      {yucatanUnlockFlash && (() => {
        const yucatan = RECUERDOS_PINS.find((p) => p.id === "yucatan");
        const flashCopy = yucatanUnlockFlashCopy(uiLang);
        return (
        <div data-testid="yucatan-unlock-flash" aria-hidden="true" style={{ position: "fixed", inset: 0, zIndex: 62, background: "rgba(0,0,0,.45)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
          <div className="pop" style={{ background: D.card, borderRadius: 20, padding: 16, maxWidth: 320, width: "100%" }}>
            <div style={{ position: "relative", height: 168, borderRadius: 16, overflow: "hidden", background: theme === "dark" ? D.subtle : "#F4EDE0", border: `2px solid ${D.line}` }}>
              ...
              <div
                data-testid="yucatan-unlock-flash-pin"
                style={{
                  position: "absolute", left: `${yucatan.x}%`, top: `${yucatan.y}%`,
                  transform: "translate(-50%, -50%)",
                  display: "flex", flexDirection: "column", alignItems: "center", minWidth: 52, zIndex: 2,
                }}
              >
          ...
          <div onClick={(e) => e.stopPropagation()} style={{ background: theme === "dark" ? D.card : HUB_CREAM, borderRadius: 20, padding: "16px 20px 20px", maxWidth: 420, width: "100%", maxHeight: "85vh", overflowY: "auto" }}>
            ...
            <div data-testid="sobremesa-tips">
              <button type="button" data-testid="sobremesa-tips-summary" aria-expanded={sobremesaTipsOpen}
                onClick={() => setSobremesaTipsOpen((open) => !open)}
                style={{ background: "none", border: "none", fontFamily: "inherit", fontSize: 13, fontWeight: 900, color: D.sub, cursor: "pointer", padding: "6px 0" }}>
                {sobremesaTipsLabel(uiLang)}
              </button>
              {sobremesaTipsOpen && (
                <ul data-testid="sobremesa-tips-list" style={{ margin: "6px 0 0", padding: "0 0 0 1.15em", display: "grid", gap: 8 }}>
                  {sobremesaTips(uiLang).map((tip) => (
                    <li key={tip.line} data-testid="sobremesa-tip" data-mexico={tip.mexico ? "1" : undefined} style={{ fontSize: 13.5, fontWeight: 800, lineHeight: 1.4, color: D.ink }}>{sobremesaTipText(tip)}</li>
                  ))}
                </ul>
              )}
            </div>
            <div data-testid="sobremesa-deepen">
              <button type="button" data-testid="sobremesa-deepen-summary" aria-expanded={sobremesaDeepenOpen}
                onClick={() => setSobremesaDeepenOpen((open) => !open)}
                style={{ background: "none", border: "none", fontFamily: "inherit", fontSize: 13, fontWeight: 900, color: D.sub, cursor: "pointer", padding: "10px 0 6px" }}>
                {sobremesaDeepenLabel(uiLang)}
              </button>
              {sobremesaDeepenOpen && (
                <div data-testid="sobremesa-deepen-body" style={{ display: "grid", gap: 12, marginTop: 4 }}>
                  {sobremesaDeepen(uiLang).subjunctive.map((line) => (
                    <div key={line} data-testid="sobremesa-deepen-line" style={{ fontSize: 13.5, fontWeight: 800, lineHeight: 1.4, color: D.ink }}>{line}</div>
                  ))}
                  {sobremesaDeepen(uiLang).porpara.map((line) => (
                    <div key={line} data-testid="sobremesa-deepen-line" style={{ fontSize: 13.5, fontWeight: 800, lineHeight: 1.4, color: D.ink }}>{line}</div>
                  ))}
                </div>
              )}
