...
},
{
  ...
  questions: [
    ...
    { prompt: "¿Por qué se negó a vender toda su cosecha a una sola empresa japonesa?", choices: ["Porque no quería depender de una sola empresa", "Porque la empresa no pagaba bien", "Porque la cooperativa no se lo permitía", "Porque la cosecha era demasiado pequeña"], answer: "Porque no quería depender de una sola empresa", skill: "Lectura", explain: { es: "La oferta era premium. Se negó por independencia, no por mal pago.", en: "The offer was premium. He refused for independence, not bad pay." } },
