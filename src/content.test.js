...
assert(cerezasWhyQ.explain?.es === "La oferta era premium. Se negó por independencia, no por mal pago.", "cerezas refused ES Why is George stamp");
assert(cerezasWhyQ.explain?.en === "The offer was premium. He refused for independence, not bad pay.", "cerezas refused EN Why is George stamp");
