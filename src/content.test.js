...
import { HANGMAN_ACCENTS, HANGMAN_BANK, HANGMAN_HOWTO, HANGMAN_QUIET, HANGMAN_TIMER_DEFAULT, HANGMAN_TITLE, hangmanTitle } from "./hangman.js";
...
const hangmanSlice = appSrc.slice(appSrc.indexOf("screen === \"ahorcado\""), appSrc.indexOf("{/* ---------- JEOPARDY SOLO"));
