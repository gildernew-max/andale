...
assert(bounceSrc.includes("41.667%"), "bird exit starts at 300ms (41.667% of 720)");
assert(bounceSrc.includes("left: 72%; top: -18%"), "entry starts at x 72%, y -18%");
assert(bounceSrc.includes("left: 54%; top: 24%"), "entry lands at x 54%, y 24%");
assert(bounceSrc.includes("left: 18%; top: -22%"), "exit ends at x 18%, y -22%");
assert(bounceSrc.includes("rotate(-12deg)"), "entry starts at -12°");
assert(bounceSrc.includes("rotate(4deg)"), "entry lands at +4°");
assert(bounceSrc.includes("rotate(-8deg)"), "exit ends at -8°");
