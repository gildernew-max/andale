...
const MEMORY_FACE_BANK = [
  ["chamba", "a job / work", "trabajo / chamba", "MX strong", "Everyday MX for work", "Forma viva MX de trabajo", ["ES", "AR"]],
  ["neta", "for real / the truth", "de verdad / la neta", "MX strong", "¿Neta? = seriously?", "¿Neta? = ¿en serio?", ["ES", "AR"]],
  ["órale", "come on / alright", "ándale / órale", "MX strong", "Agree, urge, or wow", "Anima, acepta o sorprende", ["ES", "AR", "CO"]],
  ["carnal", "buddy", "cuate / carnal", "MX strong", "Close friend", "Amigo cercano", ["ES", "AR"]],
  ["morra", "young woman (casual)", "chava / morra", "MX strong", "Pair: morro for guys", "Él: morro", ["ES", "AR", "CO"]],
  ["chido", "cool", "padre / chido", "MX strong", "Default MX \u201Ccool\u201D", "El cool mexicano", ["ES", "AR"]],
  ["gacho", "lame / mean", "feo / gacho", "MX strong", "Bad vibe", "Mal plan o injusto", []],
  ["chafa", "low-quality", "de mala calidad", "MX strong", "Cheap that shows", "Barato que se nota", []],
  ["bronca", "trouble / fight", "lío / bronca", "Wide LATAM", "Hay bronca = problem", "Problema serio o pelea", []],
  ["onda", "vibe / what\u2019s up", "rollo / onda", "MX strong", "¿Qué onda?", "¿Qué onda? saluda", ["ES"]],
  ["chela", "beer", "cerveza (coloquial)", "MX / CO", "Casual beer", "Cerveza entre cuates", []],
  ["antro", "club", "antro / club", "MX strong", "Nightlife spot", "Lugar de la noche", ["ES", "AR"]],
  ["elote", "street corn (cob)", "elote", "MX / Wide", "Street food corn", "Maíz de puesto", []],
  ["esquites", "corn in a cup", "esquites", "MX strong", "Cup + spoon", "Elote en vaso", ["ES", "AR", "CO"]],
  ["tianguis", "open-air market", "tianguis / mercado", "MX strong", "Barrio market day", "Mercado del barrio", ["ES"]],
  ["combi", "shared van", "combi / camioneta", "MX strong", "Fixed-route van", "Ruta fija urbana", ["ES", "AR", "CO"]],
  ["cruda", "hangover", "resaca / cruda", "MX strong", "Morning after", "Después de la peda", ["ES", "AR", "CO"]],
  ["chisme", "gossip", "chisme", "Wide LATAM", "Social sport", "Cotilleo vivo", []],
  ["apapacho", "warm hug / comfort", "apapacho / mimo", "MX strong", "Soft care", "Cariño que consuela", ["ES", "AR", "CO"]],
  ["fresa", "preppy person", "fresa", "MX strong", "Posh type (can tease)", "Tipo zona nice", ["ES"]],
];
