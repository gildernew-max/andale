...
assert(nextHoy?.title === "WhatsApp del plomero", "tomorrow Hoy on 2026-09-05 is WhatsApp del plomero (day-hash 8 scenes)");
assert(nextHoy?.titleEn === "Plumber WhatsApp", "EN tomorrow Hoy on 2026-09-05 is Plumber WhatsApp (day-hash 8 scenes)");
assert(comeBackTomorrowLine({ lang: "es", nextTitle: nextHoy.title }) === "Vuelve mañana por «WhatsApp del plomero».", "George ES teaser lock: Vuelve mañana por «{title}».");
assert(comeBackTomorrowLine({ lang: "en", nextTitle: nextHoy.titleEn }) === "Come back tomorrow for “Plumber WhatsApp”.", "George EN teaser lock: Come back tomorrow for “{title}”.");
